    	 ...
    	 <div class="well profile">
            <div class="col-sm-12">
                <div class="col-xs-12 col-sm-8"> 
                    ...
                    <p style="font-size:18px;"><i class="fa fa-tasks"></i><strong> {{trans('Profile')}} {{trans('Created on')}}:</strong> {{ date("d F Y",strtotime($user->created_at)) }}</p>
                    <p style="font-size:18px;"><i class="fa fa-tasks"></i><strong> {{trans('Profile')}} {{trans('Updated on')}}:</strong> {{ date("d F Y",strtotime($user->updated_at)) }}</p>
                </div>             
            ...
            <div class="col-xs-12 divider text-center">
                ...
                $user = Sentry::findUserById($id); ?>
                  ...
                  @if (Sentry::getUser()->hasAccess('admin'))
                   ...
                   <button style="width: 100%;cursor: default;" class="btn "><span class="fa fa-cogs"></span> Unpermitted </button>
                    @endif
                </div>
                <div class="col-xs-12 col-sm-4 emphasis">
                ...
                <div class="col-xs-12 col-sm-4 emphasis">
                    ...
                    <a data-toggle="tab" href="#edit"><button class="btn btn-info btn-block" onClick="$.scrollTo($('#thirdLine'), 500);"><span class=" fa fa-edit"></span> {{trans('Edit My Profile')}} </button></a>
                </div>
                </div>
            </div>
    	 </div>                 
