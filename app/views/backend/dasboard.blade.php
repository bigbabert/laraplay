...
@section('content')
                  ...
                  <div style="width: 80%;margin-left: 18%;padding-right: 2%;" class="col-lg-9 main-chart">
<div  class="row mtbox">
...
<div style="width: 80%;margin-left: 18%;padding-right: 2%;" class="row mt">
                      <!-- SERVER STATUS PANELS -->
						...
						<a href="{{ action('UserController@show', array($user->id)) }}">
                                                    <div class="white-panel pn">
								<div class="white-header">
									<h5>TOP USER</h5>
								</div>
                    ...
                    <div style="width: 80%;margin-left: 18%;padding-right: 2%;" class="row">
						<!-- TWITTER PANEL -->
						<div class="col-md-4 mb">
					...
					<div style="width: 80%;margin-left: 18%;padding-right: 2%;padding-bottom: 5%;" class="row mt">
                      <!--CUSTOM CHART START -->
