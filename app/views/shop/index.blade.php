...
<html lang="en" ng-app="app">
  <head>
    ...
    <link
      type="text/css"
      rel="stylesheet"
      href="{{ asset("assets/shop/css/bootstrap.3.0.3.min.css") }}"
    />
    <link
      type="text/css"
      rel="stylesheet"
      href="{{ asset("assets/shop/css/bootstrap.theme.3.0.3.min.css") }}"
    />
    <link
      type="text/css"
      rel="stylesheet"
      href="{{ asset("assets/shop/css/shared.css") }}"
    />
    <script
      type="text/javascript"
      src="{{ asset("assets/shop/js/angularjs.1.2.4.min.js") }}"
    ></script>
    <script
      type="text/javascript"
      src="{{ asset("assets/shop/js/angularjs.cookies.1.2.4.min.js") }}"
    ></script>
  </head>
  <body ng-controller="main">
    ...
    <script
      type="text/javascript"
      src="{{ asset("assets/shop/js/shared.js") }}"
    ></script>
  </body>
</html>