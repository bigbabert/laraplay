...
<title>Alter App - Something Went Wrong</title>
...
<div class="error_main">
    <div class="error_detail_1"><img src="{{asset('assets/img/errorpages/logo12.png')}}" alt=""/></div>
    ...
    <div class="error_detail_4"><a href="{{url('backend/dashboard')}}">Go back to Dashboard ?</a></div>
</div>
